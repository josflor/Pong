...
public class PongSinglePlayer {
    ...
    private void movePaddle2() {
        ...
        double paddle_half = paddle2.getHeight() / 2;

        double ball_position = ball.getCenterY();

        if (ball_position > paddle_position2 + paddle_half) {
            paddle_speed2 = speed_down;
        } else if (ball_position < paddle_position2 + paddle_half) {
            paddle_speed2 = speed_up;
        }
